...
def main(cfg):
    ...
    trainSet_path, valSet_path = data_obj.makeTVSets(train_split_ratio=cfg.INIT_POOL.INIT_RATIO, \
    ...
    wandb.watch(model, log="all", log_freq=19)
    ...
    for cur_iter, (inputs, labels) in enumerate(train_loader):
        ...
        if True:
            if cur_iter != 0 and cur_iter%19 == 0:
                ...
                wandb.log({"epoch": cur_epoch, "loss": loss})
